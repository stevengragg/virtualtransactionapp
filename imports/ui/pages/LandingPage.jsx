        ...
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-left">
            <p className="uppercase tracking-loose w-full">
              Virtual Transaction Assistant
            </p>
            <h1 className="my-4 text-5xl font-bold leading-tight">
              UCC Congress Registrar office is within your reach
            </h1>
            <p className="leading-normal text-2xl mb-8">
              Register and start creating your first request.
            </p>
            <Link
              to="/register"
          ...
          <div className="flex flex-wrap">
            <div className="w-5/6 sm:w-1/2 p-6">
              ...
              <p className="text-gray-600 mb-8">
                ...
                <br />✅ After that, you can now fill up the request form with
                required fields and documents you want to request.
                <br />✅ Hit "Submit" and that's it! Wait for an email with your
                scheduled appointment to the Registrar.
              </p>
            </div>
          ...
          <div className="flex flex-wrap flex-col-reverse sm:flex-row">
            ...
            <div className="w-full sm:w-1/2 p-6 mt-6">
              <div className="align-middle">
                ...
                <p className="text-gray-600 mb-8">
                  Do not forget to bring required documents before going to the
                  Registrar
                  <br />
                  <br />
                </p>
